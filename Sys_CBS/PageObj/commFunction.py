...
class CommFunction:
    ...
    def get_menu_to_script(self):
        dict_menu_to_script = {
            "登录":"script.testunite.login|Login",
            "商品贷产品系列":"script.testunite.product_Line_CommodityLoan|ProductLineCommodityLoan",
            #"商品类型":"script.testunite.product_CommodityCategory|ProductCommodityCategory",
            "现金贷产品系列":"script.testunite.product_Line_CashLoan|ProductLineCashLoan",
            "销售人员入职申请":"script.testunite.salesman_Apply|SalesmanApply",
            "销售人员入职审核":"script.testunite.salesman_CheckApply|SalesmanCheckApply",
            "商户门店准入申请":"script.testunite.channel_RetailStore_RetailStoreApply|ChannelRetailStoreRetailStoreApply",
            "商户门店准入审批": "script.testunite.channel_RetailStore_RetailStoreApprove|ChannelRetailStoreRetailStoreApprove",
            "退款审批":"script.testunite.afterLoan_RefundApprove|AfterLoanRefundApprove",
            "退保审批":"script.testunite.afterLoan_WithdrawInsuranceApprove|AfterLoanWithdrawInsuranceApprove",
            "合同查询":"script.testunite.statisticalQuery_ContractQuery|StatisticalQueryContractQuery",
            "期款协议上传":"script.testunite.afterLoan_PaymentAgreementUpload|AfterLoanPaymentAgreementUpload",
            "期款豁免录入":"script.testunite.afterLoan_TermAmtExemptionApply|AfterLoanTermAmtExemptionApply",
            "期款豁免复核":"script.testunite.afterLoan_TermAmtExemptionApprove|AfterLoanTermAmtExemptionApprove",
            "门店管理":"script.testunite.channel_RetailStore_Store|ChannelRetailStoreStore",
            "培训结果登记":"script.testunite.salesman_TrainingResults|SalesmanTrainingResults",
            "用户管理":"script.testunite.system_User|SystemUser",
            "退货审批":"script.testunite.afterLoan_SalesReturnApprove|AfterLoanSalesReturnApprove",
            "商品贷产品配置": "script.testunite.product_Config_CommodityLoan|ProductConfigCommodityLoan",
            "现金贷产品配置": "script.testunite.product_Config_CashLoan|ProductConfigCashLoan",
            "费用维护": "script.testunite.product_CostType|ProductCostType",
            "商品类型": "script.testunite.product_Type|ProductType",
            "核算交易定义": "script.testunite.product_AccountingConfig_Transaction|ProductAccountingConfigTransaction",
            "账务代码定义": "script.testunite.product_AccountingConfig_AccountCode|ProductAccountingConfigAccountCode",
            #"业务组件管理": "script.testunite.product_AccountingConfig_AccountCode|ProductAccountingConfigAccountCode",
            "影像类型配置": "script.testunite.product_ImageTypeConfig|ProductImageTypeConfig",
            "门店准入申请": "script.testunite.channel_RetailStore_StoreApply|ChannelRetailStoreStoreApply",
            "门店准入审批": "script.testunite.channel_RetailStore_StoreApprove|ChannelRetailStoreStoreApprove",
            "商户信息变更申请": "script.testunite.channel_RetailStore_RetailChangeApply|ChannelRetailStoreRetailChangeApply",
            "商户信息变更审核": "script.testunite.channel_RetailStore_RetailChangeApprove|ChannelRetailStoreRetailChangeApprove",
            "门店信息变更申请": "script.testunite.channel_RetailStore_StoreChangeApply|ChannelRetailStoreStoreChangeApply",
            "门店信息变更审核": "script.testunite.channel_RetailStore_StoreChangeApprove|ChannelRetailStoreStoreChangeApprove",
            "商户管理": "script.testunite.channel_RetailStore_Retail|ChannelRetailStoreRetail",
            "门店设备申请": "script.testunite.channel_RetailStore_StoreEquipmentApply|ChannelRetailStoreStoreEquipmentApply",
            "门店设备申请审核": "script.testunite.channel_RetailStore_StoreEquipmentApprove|ChannelRetailStoreStoreEquipmentApprove",
            "银行账号申请": "script.testunite.channel_BankAccount_Apply|ChannelBankAccountApply",
            "银行账号审批": "script.testunite.channel_BankAccount_Approve|ChannelBankAccountApprove",
            "银行代码管理": "script.testunite.channel_BankCode|ChannelBankCode",
            "代扣渠道维护": "script.testunite.channel_withholdChannel|ChannelwithholdChannel",
            "保险供应商管理": "script.testunite.channel_InsuranceSupplier|ChannelInsuranceSupplier",
            "销售人员信息变更申请": "script.testunite.salesman_ChangeApply|SalesmanChangeApply",
            "销售人员变更审核": "script.testunite.salesman_CheckChangeApply|SalesmanCheckChangeApply",
            "贷款审批": "script.testunite.loan_Approve|LoanApprove",
            "流程监控": "script.testunite.loan_ProcessMonitoring|LoanProcessMonitoring",
            "合同撤销": "script.testunite.loan_Contract_VoidableContract|LoanContractVoidableContract",
            "批量付款管理": "script.testunite.financial_BatchPay|FinancialBatchPay",
            "合同冻结付款管理": "script.testunite.financial_ContractFreezingPay|FinancialContractFreezingPay",
            "退款登记": "script.testunite.financial_RefundApply|FinancialRefundApply",
            "退款复核": "script.testunite.financial_RefundReview|FinancialRefundReview",
            "退货登记": "script.testunite.financial_SalesReturnApply|FinancialSalesReturnApply",
            "小牛在线每日放款检查": "script.testunite.financial_XIAONIUEveryDayLoanCheck|FinancialXIAONIUEveryDayLoanCheck",
            "合作机构每日放款检查": "script.testunite.financial_CooperationEveryDayLoanCheck|FinancialCooperationEveryDayLoanCheck",
            "代扣账号变更审批": "script.testunite.afterLoan_WithholdAccountChangeApprove|AfterLoanWithholdAccountChangeApprove",
            "强制还款": "script.testunite.afterLoan_ForceRepayment|AfterLoanForceRepayment",
            "商户查询": "script.testunite.statisticalQuery_RetailQuery|StatisticalQueryRetailQuery",
            "门店查询": "script.testunite.statisticalQuery_StoreQuery|StatisticalQueryStoreQuery",
            "销售合同查询": "script.testunite.statisticalQuery_SalesContractQuery|StatisticalQuerySalesContractQuery",
            "还款文件查询": "script.testunite.statisticalQuery_RepaymentDocQuery|StatisticalQueryRepaymentDocQuery",
            "代扣记录查询": "script.testunite.statisticalQuery_WithHoldReCord|StatisticalQueryWithHoldReCord",
            "销售信息查询": "script.testunite.statisticalQuery_SalesInfoQuery|StatisticalQuerySalesInfoQuery",
            "部门管理": "script.testunite.system_Department|SystemDepartment",
            "角色管理": "script.testunite.system_Role|SystemRole",
            "综合信息": "script.testunite.system_Synthesis|SystemSynthesis",
            "自动豁免参数维护": "script.testunite.parameter_AutoExemptSum|ParameterAutoExemptSum",
            "代码管理": "script.testunite.parameter_CodeManage|ParameterCodeManage",
            "审批配置": "script.testunite.parameter_AuditConfig|ParameterAuditConfig",
            "方法配置": "script.testunite.parameter_MethodConfig|ParameterMethodConfig",
            "取消合同参数": "script.testunite.parameter_CancleContract|ParameterCancleContract",
            "错误类型参数": "script.testunite.parameter_ErrorType|ParameterErrorType",
            "app秒拒延时参数配置": "script.testunite.parameter_ConsumerLoan_AppSecondsfromDelay|ParameterConsumerLoanAppSecondsfromDelay",
            "黑名单管理": "script.testunite.parameter_ConsumerLoan_BlackList|ParameterConsumerLoanBlackList",
            "优质雇主名单管理": "script.testunite.parameter_ConsumerLoan_HighQualityEmployerList|ParameterConsumerLoanHighQualityEmployerList",
            "社保信息查询维护": "script.testunite.parameter_ConsumerLoan_SocialInfoQuery|ParameterConsumerLoanSocialInfoQuery",
            "临近城市维护": "script.testunite.parameter_ConsumerLoan_NearCityManage|ParameterConsumerLoanNearCityManage",
            "门店分组代码维护": "script.testunite.parameter_ConsumerLoan_StoreGroupCodeManage|ParameterConsumerLoanStoreGroupCodeManage",
            "超期未注册期限配置": "script.testunite.parameter_ConsumerLoan_ExpiredRegisteManage|ParameterConsumerLoanExpiredRegisteManage",
            "提前还款申请提前天数配置": "script.testunite.parameter_ConsumerLoan_PrepaymentApplyDayManage|ParameterConsumerLoanPrepaymentApplyDayManage",
            "CFCA身份验证配置": "script.testunite.parameter_ConsumerLoan_CFCACertIDManage|ParameterConsumerLoanCFCACertIDManage",
            "GSPN维护": "script.testunite.parameter_ConsumerLoan_GSPNManage|ParameterConsumerLoanGSPNManage",
            "流程阶段审核要点": "script.testunite.parameter_ConsumerLoan_AuditPoints_ProcessStage|ParameterConsumerLoanAuditPointsProcessStage",
            "自动取消合同天数维护": "script.testunite.parameter_ConsumerLoan_AutoCancleContract|ParameterConsumerLoanAutoCancleContract",
            "短信模板配置": "script.testunite.parameter_ConsumerLoan_SMSModelConfig|ParameterConsumerLoanSMSModelConfig",
            "Pad参数配置": "script.testunite.parameter_ConsumerLoan_PadParameterConfig|ParameterConsumerLoanPadParameterConfig",
            "第三方接口参数配置": "script.testunite.parameter_ConsumerLoan_ThirdPartyInterface|ParameterConsumerLoanThirdPartyInterface",
            "规则引擎配置": "script.testunite.parameter_ConsumerLoan_RulesEngine|ParameterConsumerLoanRulesEngine",
            "app进件": "script.testunite.app_In|AppIn",
            "sql": "script.testunite.sqloption|Sqloption",
            "信息验证": "script.testunite.merchant_InformationVerification|MerchantInformationVerification",
            "电销规则策略":"script.testunite.marketing_rule_strategy|marketing_rule_strategy",
            "营销活动定义":"script.testunite.marketing_activity_definition|marketing_activity_definition",
            "短信推广策略":"script.testunite.marketing_SMS_strategy|marketing_SMS_strategy",
            "微信推广策略":"script.testunite.marketing_WeChat_strategy|marketing_WeChat_strategy",
            "渠道管理": "script.testunite.marketing_channel_management|marketing_channel_management",
            "客户查询":"script.testunite.cust.Query_ContractQuery|QueryContractQuery"
        }
    ...
    #登录
    def login_success(self,subsystem_in,login_url_in,username_in,passwd_in):
        #处理字符编码问题
