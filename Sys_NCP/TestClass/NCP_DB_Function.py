...
class NCP_DB_Function(unittest.TestCase):
    ...
    def contractQuery(self):
        ...
        self.test.saveScreenshot_Path(self.dict_data["案例名称"],self.Screenshotfilepath) #滚动前截图
        # elem_id = ''
        self.test.scroll_saveScreenshot_Path(self.dict_data["案例名称"],self.Screenshotfilepath) #滚动后截图
